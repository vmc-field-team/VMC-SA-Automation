...
def get_aws_subnet_id(stackName):
    ...
    # print(response['Stacks'][0]['Outputs'][2]['OutputValue'])
    if response['Stacks'][0]['Outputs'][2]['OutputValue']:
        return response['Stacks'][0]['Outputs'][2]['OutputValue']
...
def get_aws_subnet_id1(stackName):
    ...
    # print(response['Stacks'][0]['Outputs'][4]['OutputValue'])
    if response['Stacks'][0]['Outputs'][4]['OutputValue']:
        return response['Stacks'][0]['Outputs'][4]['OutputValue']
...
def cmcreate_aws_infra(yamlURL, profileName, stackName, password, vpcCIDR1, vpcCIDR2, subnet1, subnet2, subnet3, subnet4, vcdr):
    client = boto3.client('cloudformation')
    ...
    response = client.create_stack(
        ...
        TemplateURL=yamlURL + 'cmworkshop-main.yml',
        Parameters=params,
